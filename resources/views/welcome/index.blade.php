...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="index.html">VIDEOTHEQUE<span class="color-b">ARCHIVES</span></a>

      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" href="{{ route('catalogues.index') }}">Videos</a>
        </li>
          ...
          <li class="nav-item">
          <a class="nav-link active" href="{{ route('templates.index') }}">admin</a>
        </li>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-between">
              <div class="title-box">
                <h2 class="title-a">A PROPOS DES VIDEOS</h2>
              </div>
            </div>
          </div>
        </div>
  ...
  <script src="assets/vendor/php-email-form/validate.js"></script> <!-- Email Form Validation JS -->
  
  <!-- Template Main JS File -->
  <script src="assets/js/main.js"></script> <!-- Custom Main JS -->
