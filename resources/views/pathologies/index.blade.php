...
<div class="container">
    ...
    <a href="{{ route('pathologies.create') }}" class="btn btn-primary">Ajouter une Pathologie</a>
    ...
    <table class="table mt-3">
        ...
        <tbody>
            @foreach ($pathologies as $pathologie)
                <tr>
                    <td>{{ $pathologie->nom_pathologie }}</td>
                    <td>{{ $pathologie->description }}</td>
                    <td>
                        <a href="{{ route('pathologies.show', $pathologie->id_pathologie) }}" class="btn btn-info">Détails</a>
                        <a href="{{ route('pathologies.edit', $pathologie->id_pathologie) }}" class="btn btn-warning">Modifier</a>
                        <form action="{{ route('pathologies.destroy', $pathologie->id_pathologie) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
