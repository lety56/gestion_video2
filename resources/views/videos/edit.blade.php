    ...
    <div class="container">
      <div class="form-wrapper">
        <div class="form-header">
          <h1 class="form-title">Modifier la vidéo</h1>
          <div class="form-divider"></div>
          <p class="form-subtitle">Modifiez les informations de la vidéo ci-dessous</p>
        </div>
        
        <form action="{{ route('videos.update', $video->id_video) }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          ...
          <div class="form-section">
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                ...
                <input type="text" id="titre" name="titre" value="{{ old('titre', $video->titre) }}" class="form-control @error('titre') is-invalid @enderror" required>
                @error('titre')
            ...
            <div class="row mb-3">
              <div class="col-md-4">
                ...
                <div class="input-group">
                  <input type="number" id="duree" name="duree" value="{{ old('duree', $video->duree) }}" min="0" step="1" class="form-control @error('duree') is-invalid @enderror" required>
              ...
              <div class="col-md-4">
                ...
                <input type="date" id="date_ajout" name="date_ajout" value="{{ old('date_ajout', $video->date_ajout) }}" class="form-control @error('date_ajout') is-invalid @enderror" required>
                @error('date_ajout')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="col-md-4">
                ...
                <input type="date" id="date_enregistrement" name="date_enregistrement" value="{{ old('date_enregistrement', $video->date_enregistrement) }}" class="form-control @error('date_enregistrement') is-invalid @enderror" required>
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                ...
                <input type="date" id="date_intervention" name="date_intervention" value="{{ old('date_intervention', $video->date_intervention) }}" class="form-control @error('date_intervention') is-invalid @enderror" required>
              ...
              <div class="col-md-12">
                ...
                <select id="id_categorie" name="id_categorie" class="form-select @error('id_categorie') is-invalid @enderror">
                  ...
                  @foreach($categories as $cat)
                    <option value="{{ $cat->id_categorie }}" @selected(old('id_categorie', $video->id_categorie) == $cat->id_categorie)>
                      {{ $cat->nom_categorie }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="col-md-12">
                ...
                <select id="id_type_operation" name="id_type_operation" class="form-select @error('id_type_operation') is-invalid @enderror">
                  ...
                  @foreach($type_operations as $TypOperation)
                    <option value="{{ $TypOperation->id_type_operation }}" @selected(old('id_type_operation', $video->id_type_operation) == $TypOperation->id_type_operation)>
              ...
              <div class="col-md-12">
                ...
                <select id="id_pathologie" name="id_pathologie" class="form-select @error('id_pathologie') is-invalid @enderror">
                  ...
                  @foreach($pathologies as $patho)
                    <option value="{{ $patho->id_pathologie }}" @selected(old('id_pathologie', $video->id_pathologie) == $patho->id_pathologie)>
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="nom_patient" name="nom_patient" value="{{ old('nom_patient', $video->nom_patient) }}" class="form-control @error('nom_patient') is-invalid @enderror">
                </div>
                @error('nom_patient')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="nom_docteur" name="nom_docteur" value="{{ old('nom_docteur', $video->nom_docteur) }}" class="form-control @error('nom_docteur') is-invalid @enderror">
                </div>
                @error('nom_docteur')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="nom_intervenant" name="nom_intervenant" value="{{ old('nom_intervenant', $video->nom_intervenant) }}" class="form-control @error('nom_intervenant') is-invalid @enderror">
                </div>
          ...
          <div class="form-section">
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <label for="chemin_fichier" class="form-label">Fichier vidéo</label>
                ...
                @if($video->chemin_fichier)
                  ...
                  <div class="form-text">Vidéo actuelle. Laissez vide pour conserver ce fichier.</div>
                @endif
                ...
                <div class="file-upload">
                  ...
                  <div class="file-upload-btn">
                    ...
                    <span class="file-upload-text">Choisir un nouveau fichier vidéo</span>
                  </div>
                </div>
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                ...
                <select id="est_telechargeable" name="est_telechargeable" class="form-select @error('est_telechargeable') is-invalid @enderror">
                  ...
                  <option value="1" @selected(old('est_telechargeable', $video->est_telechargeable) == 1)>Oui</option>
                  <option value="0" @selected(old('est_telechargeable', $video->est_telechargeable) == 0)>Non</option>
                </select>
