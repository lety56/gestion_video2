...
<div class="container">
    ...
    <div class="card mt-3 p-4">
        <h3>{{ $type->nom_type_operation }}</h3>
        <p><strong>Description :</strong> {{ $type->description ?? 'Aucune' }}</p>
    </div>

    <a href="{{ route('type-operations.index') }}" class="btn btn-secondary mt-3">Retour à la liste</a>
</div>
@endsection
